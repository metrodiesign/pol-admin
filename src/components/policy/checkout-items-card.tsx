              ...
              >
                ...
                <td className="px-4 py-4 text-right">
                  <input
                    ...
                    className="h-9 w-28 rounded-control border border-[var(--divider)] bg-transparent px-2.5 text-right text-base tabular-nums text-foreground outline-none focus:border-primary focus:ring-1 focus:ring-inset focus:ring-primary"
                  />
                </td>

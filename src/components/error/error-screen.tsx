...
export const errorButtonOutlineClass =
  "mt-3 inline-flex h-11 w-full items-center justify-center rounded-control border border-grey-300 bg-background px-5 text-base font-semibold text-foreground transition-colors hover:bg-grey-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-1";

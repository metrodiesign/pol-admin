...
import type { Permission, Role } from "@/types/producer-role";
import { grantedCount, isRoleDeletable } from "@/lib/producer-role/role-permissions";
...
import { RolePermissionProgress } from "./role-permission-progress";

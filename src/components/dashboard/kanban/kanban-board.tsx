      ...
      >
        ...
        <div className="shrink-0">
          <button
            ...
            className="flex h-14 w-[200px] items-center gap-1.5 whitespace-nowrap rounded-control px-4 text-base font-semibold text-grey-800 transition-colors hover:bg-grey-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"

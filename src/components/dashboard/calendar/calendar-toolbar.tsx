  ...
  return (
    <div className="flex items-center justify-between border-b border-border px-3 py-2.5">
      ...
      {isMobile ? (
        ...
        <button
          type="button"
          className="flex items-center gap-1.5 rounded-lg border border-border bg-transparent px-2 py-1.5 text-base text-grey-700 transition-colors hover:bg-grey-100"
        >
      ...
      <div className="flex items-center gap-2">
        <button
          type="button"
          onClick={onToday}
          className="rounded-lg px-2 py-1 text-base font-semibold leading-[22px] text-white transition-opacity hover:opacity-90"

  ...
  return (
    <div>
      ...
      <div className="mt-2 flex items-center gap-2">
        ...
        <span className="text-base text-grey-500">({reviews} reviews)</span>
      </div>
      ...
      <div className="mt-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <SelectTrigger aria-label="Size" className="h-10 w-[88px] text-base">
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
              {SIZES.map((s) => (
          ...
          <button type="button" className="text-base text-grey-800 underline">
            Size chart
          </button>
        </div>
      </div>
      ...
      <div className="mt-6 flex gap-3">
        <button
          ...
          disabled={isOutOfStock}
          className={cn(
            "flex flex-1 items-center justify-center gap-2 rounded-lg py-3 text-base font-semibold transition-colors",
            isOutOfStock
      ...
      <div className="mt-4 flex items-center justify-center gap-6">
        {[
          ...
          <button
            key={label}
            type="button"
            className="flex items-center gap-1.5 text-base font-semibold text-grey-600 transition-colors hover:text-foreground"
          >

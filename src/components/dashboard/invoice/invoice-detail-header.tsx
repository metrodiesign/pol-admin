    ...
    <div className="mb-5">
      ...
      <div className="mt-4 flex flex-wrap items-end justify-between gap-4">
        ...
        <div className="flex shrink-0 flex-col gap-1">
          <label id={statusId} className="text-base font-medium text-grey-500">Status</label>
          <Select value={status} onValueChange={(v) => setStatus(v as MinimalsInvoiceStatus)}>
            <SelectTrigger aria-labelledby={statusId} className="w-40 text-base font-medium">

...
import { FileUpgradeCard } from "./file-upgrade-card";
...
/** Desktop right-rail stack:
 *  - Card: upload zone + semi-circle gauge + category breakdown
 *  - Upgrade plan card
 */
export function FileStorageOverview() {
  ...
  return (
    <div className="space-y-6">
      {/* Standalone dashed upload zone — NOT inside a card */}
      <FileUploadZone />

      {/* Storage card: gauge + breakdown only */}
      <div className="dashboard-card p-6">
        ...
        <div className="relative w-full" style={{ aspectRatio: "220/120" }}>
          <svg viewBox="0 0 220 120" width="100%" height="100%" style={{ display: "block" }}>
            <defs>
              <linearGradient id="gaugeGradDesktop" x1="0%" y1="0%" x2="100%" y2="0%">

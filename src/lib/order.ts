import type { Order, OrderStatus, PaymentChannel, Psp } from "@/types/order-payment";
...
export function getOrderById(id: string | undefined): Order | undefined {
  ...
  return ORDERS.find((t) => t.id === id || t.code === id);
}
...
export function downloadCsv(filename: string, rows: Order[]): void {
...
// \u2500\u2500 \u0e2b\u0e19\u0e49\u0e32 detail: derive \u0e02\u0e49\u0e2d\u0e21\u0e39\u0e25\u0e19\u0e33\u0e40\u0e2a\u0e19\u0e2d\u0e08\u0e32\u0e01 order \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500
...
export function payLink(t: Order): { code: string; url: string } {
  const s = seedOf(t);
...
export function sourceDetail(t: Order): SourceDetail {
  const s = seedOf(t);
...
export function policyItems(t: Order): PolicyItem[] {
  const s = seedOf(t);
...
export function buildTimeline(t: Order): TimelineEvent[] {
